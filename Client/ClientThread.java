...
public class ClientThread implements Runnable{
    ...
    public ClientThread(Socket socket, MainForm main){
        ...
        try {
            ...
            main.appendMessage("[IOException]: "+ e.getMessage(), "Error", Color.RED, Color.BLACK);
        }
    }
            ...
            while(!Thread.currentThread().isInterrupted()){
                ...
                switch(CMD){
                    ...
                    case "CMD_PVMESSAGE":
                        ...
                        main.appendMessage(msg, "[private] "+frm, Color.GRAY, Color.GRAY);
                        break;
                    ...
                    case "CMD_ONLINE":
                        ...
                        Vector online = new Vector();
                           online.add(main.getMyUsername() + " (you)");
                               while(st2.hasMoreTokens()){
                              String list = st2.nextToken();
                    ...
                    case "CMD_FILE_XD":  // Format:  CMD_FILE_XD [sender] [receiver] [filename]
                        ...
                        int confirm = JOptionPane.showConfirmDialog(main, "From: "+frm+"\nFilename: "+fname+"\nwould you like to Accept.?");
                        ...
                        if(confirm == 0){ // client accepted the request, then inform the sender to send the file now
                            ...
                            try {
                                ...
                                String format = "CMD_SEND_FILE_ACCEPT "+frm+" accepted";
                                dos.writeUTF(format);
                            ...
                            try {
                                ...
                                String format = "CMD_SEND_FILE_ERROR "+frm+" Client rejected your request or connection was lost.!";
                                dos.writeUTF(format);
                            } catch (IOException e) {
                                System.out.println("[CMD_FILE_XD]: "+e.getMessage());
                            }
