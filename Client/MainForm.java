...
public class MainForm extends javax.swing.JFrame {
    ...
    private StringTokenizer userList;
    ...
    public void connect(){
        ...
        try {
            ...
            appendMessage(" Type your message now!", "Status", Color.BLACK, Color.BLACK);
    ...
    */
    public void appendMyMessage(String msg, String header){
        jTextPane1.setEditable(true);
        getMsgHeader(header, Color.MAGENTA);
    ...
    public void appendMyMessage(String msg, String header, Color headerColor, Color contentColor ){
        jTextPane1.setEditable(true);
        getMsgHeader(header, headerColor);
        getMsgContent(msg, contentColor);
        jTextPane1.setEditable(false);
    ...
    */
    ...
    private void initComponents() {
        ...
        /*
         * NANTI ATUR LAGI WARNA SAMA SESUAI DENGAN ACTION YANG DI PERFORM 
         * KALAU MAU GANTI WARNANYA ADA D DALEM FUNGSI AJA
         */
        jButton2.setBackground(new java.awt.Color(168, 16, 22));
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Lock User");
        ...
        jScrollPane1.setViewportView(jTextPane1);
              ...
              txtpane2.setForeground(new java.awt.Color(0, 14, 3));
        ...
        btnUpload = new JButton("Send File");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
        	...
        	{
        		String content = username+" "+jTextField2.getText()+" "+ jTextField1.getText();
                dos.writeUTF("CMD_CHAT "+ content);
                appendMyMessage(" "+jTextField1.getText(), "[private] to "+jTextField2.getText(), Color.GRAY, Color.GRAY);
                jTextField1.setText("");
        	}
    ...
    //TEST
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_jButton1ActionPerformed
    	...
    	if(lock==true)
        {
    	 ...
    	 else if(lock==false && jTextField2.getText()!="")
		{
			lock=true;
    ...
    private void LogoutMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutMenuActionPerformed
        ...
        if(confirm == 0){
            try {
            	dos.writeUTF("CMD_CHATALL "+ username +" "+ "Disconnect from Server");
                appendMyMessage(" "+"Disconnect from Server", username);
                socket.close();
